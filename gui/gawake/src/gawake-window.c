...
gawake_window_class_init (GawakeWindowClass *klass)
{
	...
	gtk_widget_class_set_template_from_resource (widget_class, "/com/kelvinnovais/Gawake/ui/gawake-window.ui");
	gtk_widget_class_bind_template_child (widget_class, GawakeWindow, header_bar);
